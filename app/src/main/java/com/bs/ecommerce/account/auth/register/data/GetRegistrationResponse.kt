...
data class GetRegisterData(
    ...
    @SerializedName("FirstNameEnabled") var firstNameEnabled: Boolean = false,
    @SerializedName("FirstNameRequired") var firstNameRequired: Boolean = false,
    ...
    @SerializedName("LastNameEnabled") var lastNameEnabled: Boolean = false,
    @SerializedName("LastNameRequired") var lastNameRequired: Boolean = false,
